      ...
      <header className="border-b border-gray-200 py-2 px-3 sm:px-4">
        <div className="max-w-4xl mx-auto flex items-center justify-center relative">
          ...
          <h1 className="text-lg sm:text-xl text-blue-500 font-bold flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-1.5 sm:mr-2 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main className="flex-grow overflow-y-auto">
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center p-8 text-gray-400">
            ...
            <p className="text-xl font-medium mb-2">Ask anything about first aid or medical procedures</p>
            <p className="mt-2 max-w-lg text-base">For example: "How do I perform CPR?" or "What should I do for a snake bite?"</p>
          </div>
        ) : (
          <div>
        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="mb-3">
            <div className="flex items-center text-accent-dark text-xs">
              ...
              For emergencies, call the ethiopian national emergency number 907 immediately. This AI is not a substitute for professional medical advice.
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="relative">
            <div className="relative shadow-sm rounded-3xl border border-gray-300">
              ...
              onInput={(e) => {
                ...
                target.style.height = Math.min(target.scrollHeight, 150) + 'px'; // Reduced max height
              }}
              onKeyDown={(e) => {
